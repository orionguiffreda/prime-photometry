...
def astrom(outpath):
    ...
    for f in inpath:
        ...
        #add ' ' + dif + f to above if using dir and it isnt working
        s0 = ''
        com = s0.join(com)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-list', action='store_true', help='if downloading from a list of file paths (flist), use this optional arg')
