...
from photometrus.settings import PIPELINE_DEFAULT_DIR, gen_config_file_name, PHOTOMETRY_MAG_UPPER_LIMIT, PHOTOMETRY_MAG_LOWER_LIMIT
...
ASTROM_DEFAULTS_NEW = dict(length=125,num=400,thresh_high=0.4,thresh_low=0.1,iters=10,test=False,adv_solve=False)